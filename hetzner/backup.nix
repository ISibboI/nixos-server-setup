{ config, pkgs, ... }: {
  ...
  systemd.services."backup-daily" = {
    script = ''
      ...
      readonly SOURCE_CONFIGS=("/home/syncthing:syncthing" "/syncthing_shared:syncthing_shared" "/var/lib/immich:immich" "/var/lib/nextcloud:nextcloud" "/var/lib/hass/backups:hass")
